...
import { useAddAccountMutation } from '../../../features/account/accountApiSlice'
    ...
    return (
        <>
            ...
            {isSuccess &&
                ...
                <Notification isOpen={true} title="The account was successfully added!" type="success" vertical="top" horizontal="right" />
            }
        </>
    );
}
