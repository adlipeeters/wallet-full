        ...
        >
          ...
          >
            ...
            >
              ...
              <Link to="../pricing">
                <span style={{ color: "#2575fc" }}>Register</span>
              </Link>
            </Typography>
            <Box
              sx={{
            ...
            >
              <form onSubmit={handleSubmit}>
                ...
                <FormControl
                  variant="standard"
                  sx={{ minWidth: "100%", marginTop: "30px", width: "100%" }}
                >
                  <Tooltip
                    title={
                      !isValid
                        ? "Enter correct e-mail address and password should contains between 6 and 15 characters"
                        : "Press to log in"
                    }
                  >
